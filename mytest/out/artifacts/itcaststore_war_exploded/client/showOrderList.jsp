                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p>
                                                ...
                                                <br/>
                                                收货人：&nbsp;&nbsp;&nbsp;&nbsp;<input id="receiverName" name="receiverName" type="text" value="${user.getUsername}" style="width:150px"  />
                                                <span id="receiverNameMsg"></span>
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                <br/>
                                                联系方式：<input type="text" id="receiverPhone" name="receiverPhone" value="${user.getTelephone}" style="width:150px"  />
